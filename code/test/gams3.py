...
def build_prompt(context, question):
    system = (
        ...
        "Odgovori na vprašanje KRATKO in JEDRNATO v največ 3-4 stavkih.\n"
        "Če vir vsebuje relevantne informacije, jih VEDNO uporabi in navedi zakon in člen.\n"
